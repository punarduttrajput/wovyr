...
def sdk_version() -> str:
    """The installed `apex-ai-sdk` version, or the source-tree fallback."""
    try:
        return metadata.version("apex-ai-sdk")
    except metadata.PackageNotFoundError:
        return _FALLBACK_VERSION


class ApexVersionSkewWarning(UserWarning):
    ...
    `warnings.simplefilter("ignore", ApexVersionSkewWarning)`."""
...
def version_skew(sdk: str, server: str) -> Optional[str]:
    ...
    return (
        f"apex-ai-sdk {sdk} was written against apex-server "
