//! Stage 1 smoke test: connect Wovyr's MCP client to a real, locally-spawned
...
//!
//! Run: `cargo run -p wovyr-agent --example mcp_filesystem_stage1 -- <scratch-dir>`

use serde_json::json;
use std::sync::Arc;
use wovyr_tools::{McpClient, StdioTransport};
