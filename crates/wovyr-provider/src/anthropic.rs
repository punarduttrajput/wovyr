...
impl AnthropicProvider {
    ...
    ///
    /// Reads `ANTHROPIC_API_KEY` (required) and `WOVYR_ANTHROPIC_BASE_URL`
    ...
    pub fn from_env() -> Result<Self> {
        ...
        let base_url = std::env::var("WOVYR_ANTHROPIC_BASE_URL")
...
fn parse_response(
    ...
    tracing::debug!(target: "wovyr.pricing", model = %model, input, output,
