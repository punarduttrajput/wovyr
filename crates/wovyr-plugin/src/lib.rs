//! Plugin Engine for the Wovyr AI Platform — the control plane for extensions
...
//!   the [`ToolRegistry`](wovyr_tools::ToolRegistry) and emitting `plugin.*` events.
...
//!   wovyr-tools' `ContainerSandbox`), and [`WasiCapabilityRuntime`] (behind the
