//! Plugin Marketplace registry for the Wovyr AI Platform — the hosted ecosystem layer
//! over the signed plugin supply chain ([Marketplace](../../docs/08-plugin-sdk/marketplace.md)).
//!
//! Where [`wovyr_plugin`] is the **node-local** control plane (install/enable/uninstall a
...
//! depends only on [`wovyr_plugin`] (for the package/manifest/trust types it reuses) and
//! [`wovyr_common`].
//!
