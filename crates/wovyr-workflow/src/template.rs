...
//!
//! Originally lived only in `apps/wovyr-cli/src/workflow.rs`'s `PlatformExecutor` —
...
//! string to the agent when run through `wovyr-server`, never the referenced value.
