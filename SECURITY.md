...
Apex is a trust and policy layer for AI-agent interfaces — we treat security
...
[Security → Report a vulnerability](https://github.com/punarduttrajput/Apex/security/advisories/new)
...
- A description of the issue and its impact (which component: `apex-server`
...
- `disabled-loopback` auth mode, `APEX_ALLOW_ANONYMOUS=1`,
  `APEX_UNRESTRICTED_TOOLS=1`, and `APEX_UNRESTRICTED_UI=1` are documented
